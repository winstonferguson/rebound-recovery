(function (window, k) {
    if (!window.AppstleIncluded && (!urlIsProductPage() || 'V1' === 'V2')) {
      ...
      appstleLoadScript("https://cdn.shopify.com/s/files/1/0722/4272/5166/t/6/assets/appstle-subscription.js?v=1687959972");
      ...
      RS.Config = {
        ...
        "shop": "rebound-recovery-7302.myshopify.com",
        ...
        "sellingPlansJson": [{"frequencyCount":2,"frequencyInterval":"WEEK","billingFrequencyCount":2,"billingFrequencyInterval":"WEEK","frequencyName":"Bi-Weekly","afterCycle1":0,"afterCycle2":0,"discountEnabled":false,"discountEnabled2":false,"discountEnabledMasked":false,"discountEnabled2Masked":false,"id":"gid://shopify/SellingPlan/689331536174","frequencyType":"ON_PURCHASE_DAY","specificDayEnabled":false,"cutOff":0,"prepaidFlag":"false","idNew":"gid://shopify/SellingPlan/689331536174","planType":"PAY_AS_YOU_GO","deliveryPolicyPreAnchorBehavior":"ASAP","freeTrialEnabled":false,"memberOnly":false,"nonMemberOnly":false,"frequencySequence":0,"groupName":"Rebound Bi-Weekly","appstleCycles":[]}],
        "widgetEnabled": true,
        "showTooltip" : true,
